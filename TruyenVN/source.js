...
class TruyenVN extends types_1.Source {
    constructor() {
        super(...arguments);
        this.parser = new TruyenVNParser_1.Parser();
    ...
    async getMangaDetails(mangaId) {
        const response = await this.requestManager.schedule(App.createRequest({ url: `${BASE_URL}/truyen-tranh/${mangaId}`, method: 'GET' }), 0);
        const $ = this.cheerio.load(response.data);
    ...
    async getChapterDetails(mangaId, chapterId) {
        const response = await this.requestManager.schedule(App.createRequest({ url: `${BASE_URL}/truyen-tranh/${mangaId}/${chapterId}`, method: 'GET' }), 1);
        const $ = this.cheerio.load(response.data);
...
},{"./TruyenVNParser":63,"@paperback/types":61}],63:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
